...
- An example of two websites (both used during our pilot study, not used for data collection) and the server backend
- All of the filtered data used in our paper
- An example script to query ChatGPT
...
### ./query
The example ChatGPT query script. The script sends queries via API and records query+response pairs in a .CSV file for analysis.
